...
Twelve files, 19,016,770 bytes. Each byte count and hash above was measured
twice, independently — by the coordinator on the day of import and by the
builder of `E3-B03e0` before writing it here — and the two readings agreed.
